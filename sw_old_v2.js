...
self.addEventListener('install', (e) => {
	// Forzamos que el nuevo Service Worker se active y tome el control inmediatamente
	// esto es para que el nuevo Service Worker se active y tome el control de la página
	// al tomar el control de la página, el nuevo Service Worker se encargará de cachear los recursos
	// ya sea que estén en la cache o no, y de responder con los recursos cacheados si no hay conexión a internet
	self.skipWaiting();
 ...
 * o
 * Se ejecuta cuando el Service Worker se activa y toma control de la página.
 * Se utiliza para limpiar cachés antiguas y realizar tareas de mantenimiento.
